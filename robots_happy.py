...
def generate_robot(color_name):
    ...
    # Smile (wider and symmetrical like \__/)
    box(5, 9, 5, 9, colors['ACCENT'])        # left edge up
    box(6, 10, 9, 10, colors['ACCENT'])      # center down (now 4px wide)
    box(10, 9, 10, 9, colors['ACCENT'])       # right edge up
    ...
    filename = f"robot_happy_{color_name}.png"
